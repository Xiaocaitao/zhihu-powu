...
export interface RouteAgent {
  generate(input: RouteRequest, signal?: AbortSignal, onProgress?: (event: RouteProgress) => void, onDelta?: (delta: RouteDelta, channel?: "text" | "thinking") => void): Promise<RoutePlan>;
}
