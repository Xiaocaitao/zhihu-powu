...
export type TargetJob = { id: string; ownerId: string; title: string; companyName?: string; directionCode?: string; city?: string; employmentType: EmploymentType; salaryText?: string; description: string; requirements: JobRequirement[]; source: "manual" | "imported"; createdAt: string; updatedAt?: string };
...
export type CareerDashboard = { plan: CareerPlan | null; activeJob: TargetJob | null; latestGapAnalysis: JobGapAnalysis | null; recommendedActions: CareerActionProgress[]; refreshedAt: string };
...
export type SaveTargetJobInput = { title: string; companyName?: string; directionCode?: string; city?: string; employmentType?: EmploymentType; salaryText?: string; description: string; source?: "manual" | "imported"; requirements?: JobRequirement[] };
